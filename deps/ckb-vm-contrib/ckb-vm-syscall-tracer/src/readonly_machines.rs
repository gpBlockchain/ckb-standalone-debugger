use ckb_vm::{
    Bytes, CoreMachine, Error, Memory, RISCV_GENERAL_REGISTER_NUMBER, RISCV_PAGE_SHIFTS, RISCV_PAGESIZE, Register,
    SupportMachine,
...
impl<M: SupportMachine> SupportMachine for ReadonlyMachine<'_, M> {
    ...
    fn reset(&mut self, _max_cycles: u64) -> Result<(), ckb_vm::Error> {
        unreachable!()
    }
